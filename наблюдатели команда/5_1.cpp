...
public:
    VerticalMovingShape(sf::RenderWindow& window, sf::Vector2f position, sf::Vector2f size)
        : mRenderWindow(window), mShape(size), mInitialPosition(position) {
    ...
    void update(float value) override {
        mShape.setPosition(mInitialPosition.x, mInitialPosition.y - value);
    }
};
...
int main()
{
    ...
    std::vector<Observer*> observers
    {
        ...
        new VerticalMovingShape{window, {600, 600}, {50, 50}}
    };
